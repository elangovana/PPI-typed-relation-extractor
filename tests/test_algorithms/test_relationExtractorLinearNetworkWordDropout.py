...
class TestRelationExtractorLinearNetworkWordDropout(TestCase):
    def test_forward(self):
        ...
        sut = RelationExtractorLinearNetworkDropoutWord(class_size=class_size, embedding_dim=vector_dim,
