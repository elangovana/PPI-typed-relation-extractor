...
class TestRelationExtractorSimpleResnetCnnPosNetwork(TestCase):
    def setUp(self):
    ...
    def test_forward(self):
        ...
        sut = RelationExtractorSimpleResnetCnnPosNetwork(class_size=class_size, embedding_dim=vector_dim,
