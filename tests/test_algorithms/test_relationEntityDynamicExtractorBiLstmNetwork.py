...
class TestRelationExtractorDynamicEntityBiLstmNetwork(TestCase):
    def setUp(self):
    ...
    def test_forward(self):
        ...
        sut = RelationExtractorDynamicEntityBiLstmNetwork(class_size=class_size, embedding_dim=vector_dim,
