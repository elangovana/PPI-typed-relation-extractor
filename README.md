...
4. Run train job
    ```bash
    export PYTHONPATH=./source
    python source/algorithms/main_train.py  --dataset PPIDataset --trainfile sample_train.json --traindir tests/data/ --valfile sample_train.json  --valdir tests/data --embeddingfile sample_PubMed-and-PMC-w2v.bin.txt --embeddingdir ./tests/test_algorithms --embeddim 200 --outdir outdir
    ```
