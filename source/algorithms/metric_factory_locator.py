...
class MetricFactoryLocator:
    """
    General network factory that automatically loads network factories that are subclasses of BaseClassificationScorerFactory
    """

    def __init__(self):
        # Expect the datset factory is under datasets path under the parent of the __file__
        datasets_base_dir = "metrics"
        base_class = BaseClassificationScorerFactory
    ...
    def factory_names(self):
        """
        Returns the names of subclasses of BaseClassificationScorerFactory that can be dynamically loaded
        :return:
        """
    ...
    def get_factory(self, class_name):
        ...
        :param class_name: The name of the BaseClassificationScorerFactory  class, see property dataset_factory_names to obtain valid list of class names
        :return:
        """
