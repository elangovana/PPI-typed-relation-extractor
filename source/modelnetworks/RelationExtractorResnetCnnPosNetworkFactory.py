...
from modelnetworks.RelationExtractorResnetCnnPosNetwork import RelationExtractorResnetCnnPosNetwork


class RelationExtractorResnetCnnPosNetworkFactory(NetworkFactoryBase):
    ...
    def get_network(self, class_size, embedding_dim, feature_lens, **kwargs):
        ...
        model = RelationExtractorResnetCnnPosNetwork(class_size=class_size, embedding_dim=embedding_dim,
