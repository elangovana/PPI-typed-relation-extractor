...
class BulkImexProteinInteractionsExtractor:
    ...
    def __init__(self, interactionlist=None):
        ...
        self.imexProteinInteractionsExtractor = None

    @property
    def imexProteinInteractionsExtractor(self):
        self.__imexProteinInteractionsExtractor__ = self.__imexProteinInteractionsExtractor__ or ImexProteinInteractionsExtractor(
